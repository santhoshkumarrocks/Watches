		...
		<div class="col-sm-12 col-md-10 col-md-offset-1">
			<table class="table table-hover">
					...
					<tbody>
						<form action="incprod">
							<tr>
								...
								<td class="col-md-1 text-center"><strong>${ci.getPrice()}</strong></td>
								<td class="col-md-1 text-center"><strong>${ci.getTotal()}</strong></td>
								<td class="col-md-1">
				...
				<tr>
					...
					<c:if test="${sessionScope.prodtotal>0}"><td>
